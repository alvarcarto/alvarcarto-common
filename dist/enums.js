...
var POSTER_SIZE_TYPES = [{ id: 'cm', label: 'EU', description: 'Metric sizes' }, { id: 'inch', label: 'US', description: 'Inch sizes' }];

var POSTER_ORIENTATIONS = [{ id: 'portrait' }, { id: 'landscape' }];

module.exports = {
  POSTER_SIZES: POSTER_SIZES,
  POSTER_SIZE_TYPES: POSTER_SIZE_TYPES,
  POSTER_ORIENTATIONS: POSTER_ORIENTATIONS
};